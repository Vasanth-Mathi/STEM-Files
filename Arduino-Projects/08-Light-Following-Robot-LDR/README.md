...
## Description
A four-wheel robot that moves toward a bright light using two LDR sensors. The Arduino compares the left and right light levels and steers toward the brighter side.
...
## Code
See [`light_following_robot.ino`](./light_following_robot.ino).

## Working Principle
1. The left and right LDR circuits measure the amount of light.
2. A higher analog reading means more light with this wiring.
3. If the left sensor receives more light, the robot turns left.
4. If the right sensor receives more light, the robot turns right.
5. If both readings are similar, the robot moves forward.

## Use Cases
- Light-tracking experiments
- Autonomous navigation lessons
